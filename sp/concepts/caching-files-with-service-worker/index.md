...
[__Using the Cache API in the service worker__](#cacheinsw)        

[__Using the Cache API__](#cacheapi)        

[__Further reading__](#moreresources)__        __
...
__Note:__ The Cache API is available on the window object, meaning you don't need to involve the service worker to add things to the cache.
